...
async function cardMail(email, fullname, link) {
    try {
            ...
            <tr>
              <td style="text-align: start; padding: 15px">
                ...
                <p style="line-height: 24px;">
                      ...
                      You have just initiated a ${cardtype} card. Your request
                      is being reviewed you will be contacted in due course.
                      <br>
                      <br>
